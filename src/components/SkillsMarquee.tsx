    ...
    <div className="overflow-hidden relative group">
      ...
      >
        {marqueeSkills.map((skill, i) => (
          <div
            key={`${skill.name}-${i}`}
            className="group/card flex items-center gap-3 px-5 py-3 rounded-2xl border border-neutral-200 bg-white/80 backdrop-blur-sm hover:border-violet-300 hover:bg-violet-50/60 hover:shadow-md hover:shadow-violet-100 transition-all duration-300 cursor-default flex-shrink-0"
          >
  ...
  return (
    <div ref={ref} className="flex flex-col gap-1.5">
      <div className="flex items-center justify-between">
        <span className="text-sm font-bold text-black tracking-tight">{name}</span>
